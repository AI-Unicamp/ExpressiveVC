...
from inference import infer_tool_energy
from inference import slicer
from inference.infer_tool_energy import Svc

logging.getLogger('numba').setLevel(logging.WARNING)
chunks_dict = infer_tool_energy.read_temp("inference/chunks_temp.json")
...
def main():
    ...
    infer_tool_energy.fill_a_to_b(trans, clean_names)
    for clean_name, tran in zip(clean_names, trans):
        raw_audio_path = f"raw/{clean_name}"
        if "." not in raw_audio_path:
            raw_audio_path += ".wav"
        infer_tool_energy.format_wav(raw_audio_path)
        ...
        for spk in spk_list:
            ...
            for (slice_tag, data) in audio_data:
                ...
                audio.extend(list(infer_tool_energy.pad_array(_audio, length)))
