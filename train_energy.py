...
import sovits_utils
from data_utils_energy import TextAudioSpeakerLoader, TextAudioCollate
from models import (
    SynthesizerTrn_energy,
...
def train_and_evaluate(rank, epoch, hps, nets, optims, schedulers, scaler, loaders, logger, writers):
    ...
    for batch_idx, items in enumerate(train_loader):
        ...
        with autocast(enabled=hps.train.fp16_run):
            ...
            (z, z_p, m_p, logs_p, m_q, logs_q), pred_lf0, norm_lf0, lf0 = net_g(c, f0, uv, spec, energy=energy g=g, c_lengths=lengths, spec_lengths=lengths)
